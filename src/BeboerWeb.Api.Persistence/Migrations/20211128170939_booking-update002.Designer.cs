...
namespace BeboerWeb.Api.Persistence.Migrations
{
    ...
    [Migration("20211128170939_booking-update002")]
    partial class bookingupdate002
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeboerWeb.Api.Domain.Models.Bookings.Booking", b =>
                {
                    b.HasOne("BeboerWeb.Api.Domain.Models.Bookings.BookingItem", "BookingItem")
                        .WithMany("Bookings")
                        .HasForeignKey("BookingItemId");

                    b.HasOne("BeboerWeb.Api.Domain.Models.PropertyManangement.Tenant", "Tenant")
                        .WithMany("Bookings")
